...
export const TRANSITIONS = {
    ...
    overlay: {
        ...
        classNames: {
            ...
            enterActive: 'opacity-100 scale-100 transition-transform transition-opacity duration-150 ease-linear',
            exit: 'opacity-100',
...
`
    ...
    tooltip: {
        ...
        arrow: ({ context }) => ({
            className: classNames('absolute w-0 h-0 border-transparent border-solid', {
                '-mt-1 border-y-[0.25rem] border-r-[0.25rem] border-l-0 border-r-gray-800 dark:border-r-gray-200': context.right,
                '-mt-1 border-y-[0.25rem] border-l-[0.25rem] border-r-0 border-l-gray-800 dark:border-l-gray-200': context.left,
                '-ml-1 border-x-[0.25rem] border-t-[0.25rem] border-b-0 border-t-gray-800 dark:border-t-gray-200': context.top,
                '-ml-1 border-x-[0.25rem] border-b-[0.25rem] border-t-0 border-b-gray-800 dark:border-b-gray-200': context.bottom
            })
        }),
        text: {
            className: 'p-2 bg-gray-800 text-gray-200 dark:bg-gray-200 dark:text-gray-800 rounded-md whitespace-pre-line break-words'
        }
    },
    //UPLOAD
    fileupload: {
        ...
        root: ({ props, context }) => ({
            className: classNames(
                ...
                },
                {
                    ...
                    'text-white bg-cyan-500 border border-cyan-500 hover:bg-cyan-600 hover:border-cyan-600':
                        props.severity === 'info' && !props.text && !props.outlined && !props.plain,
                    'text-white bg-yellow-500 border border-yellow-500 hover:bg-yellow-600 hover:border-yellow-600':
                ...
                },
                {
                    ...
                    'text-blue-500 border border-blue-500 hover:text-white hover:bg-blue-500': props.outlined && props.severity === null && !props.plain,
                    'text-cyan-500 border border-cyan-500 hover:text-black hover:bg-blue-500': props.outlined && props.severity === 'info' && !props.plain,
                    'text-gray-600 border border-gray-600 hover:text-white hover:bg-gray-600': props.outlined && props.severity === 'secondary' && !props.plain,
                    'text-green-500 border border-green-500 hover:text-white hover:bg-green-500': props.outlined && props.severity === 'success' && !props.plain,
                    'text-yellow-500 border border-yellow-500 hover:text-black hover:bg-yellow-500': props.outlined && props.severity === 'warning' && !props.plain,
                    'text-purple-500 border border-purple-500 hover:text-white hover:bg-purple-500': props.outlined && props.severity === 'help' && !props.plain,
                    'text-red-500 border border-red-500 hover:text-black hover:bg-red-500': props.outlined && props.severity === 'danger' && !props.plain
                },
                { 'px-3 py-1.5 text-base': props.size === null, 'text-sm py-1 px-2': props.size === 'small', 'text-xl py-2 px-4': props.size === 'large' },
            ...
            className: classNames(
                ...
                'font-sans text-gray-600 dark:text-white/80 bg-white dark:bg-gray-900 border transition-colors duration-200 appearance-none rounded-lg',
                {
                    'focus:outline-none focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)] dark:focus:shadow-[0_0_0_0.2rem_rgba(147,197,253,0.5)]':
                        !context.disabled,
                    'hover:border-gray-500': !props.invalid && !context.disabled,
                ...
                {
                    'text-xl px-4 py-2': props.size === 'large',
                    'text-sm px-2 py-1': props.size === 'small',
                    'px-3 py-1.5 text-base': !props.size || typeof props.size === 'number'
                },
                {
    ...
    dropdown: {
        ...
        wrapper: {
            className: classNames('max-h-[200px] overflow-auto', 'rounded-md shadow-lg',
                'bg-white dark:bg-gray-900 text-gray-700 dark:text-white/80 border border-gray-300 dark:border-gray-700'
            )
        },
        ...
        item: ({ context }) => ({
            className: classNames(
                ...
                'm-0 p-2 border-0 transition-shadow duration-200 rounded-none',
                {
                    ...
                    'bg-blue-400 text-white dark:text-white/80': context.focused && context.selected,
                    'bg-blue-500 text-white dark:text-white/80': !context.focused && context.selected,
                    'opacity-60 select-none pointer-events-none cursor-default': context.disabled
                }
            )
        }),
    ...
    treeselect: {
        root: ({ props }) => ({
            className: classNames('inline-flex cursor-pointer select-none', 'bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 hover:border-gray-500', 'transition-colors duration-200 ease-in-out rounded-md', {
                'opacity-60 select-none pointer-events-none cursor-default': props?.disabled
            })
        }),
        labelContainer: {
        ...
        label: {
            className: classNames('block overflow-hidden whitespace-nowrap cursor-pointer overflow-ellipsis', 'text-gray-800 dark:text-white/80', 'px-3 py-1.5 transition duration-200')
        },
        trigger: {
            className: classNames('flex items-center justify-center shrink-0', 'bg-transparent text-gray-600 dark:text-white/70 w-12 rounded-tr-lg rounded-br-lg')
        },
    ...
    menu: {
        root: 'py-1 bg-white dark:bg-gray-900 text-gray-700 dark:text-white/80 border border-gray-300 dark:border-gray-700 rounded-md w-48',
        menu: {
            className: classNames('m-0 p-0 list-none', 'outline-none')
        },
        content: ({ state }) => ({
...
export const InputGroup = classNames(
    'flex [&>*]:rounded-none [&>*:first-child]:rounded-l-md [&>*:last-child]:rounded-r-md'
);

export const InputGroupAddon = classNames(
    'bg-gray-300 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 px-2 p-inputgroup-addon'
);

export default SaunaPrimeReactTailwind;